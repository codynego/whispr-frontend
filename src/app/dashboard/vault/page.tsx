      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">All your uploaded documents</p>
          </div>

          <button
            onClick={() => fileInputRef.current?.click()}
            disabled={uploading}
            className="flex items-center gap-2.5 px-6 py-3 bg-emerald-500 hover:bg-emerald-600 disabled:opacity-60 text-white font-medium rounded-xl shadow-lg transition"
          >
            {uploading ? (
          ...
          {loading ? (
            ...
            <div className="divide-y divide-gray-100">
              {files.map((file) => {
                ...
                return (
                  <div key={file.id} className="p-5 hover:bg-emerald-50/30 transition-all group">
