...
import {
  ...
  Loader2,
  Check,
  Zap, // Added icon for activation
} from "lucide-react";

// TODO: Replace with your actual WhatsApp number
const WHISONE_WHATSAPP_NUMBER = "+2348051385049";
const WHATSAPP_MESSAGE = "Hi Whisone, activate my assistant";
const WHATSAPP_LINK = `https://wa.me/${WHISONE_WHATSAPP_NUMBER}?text=${encodeURIComponent(WHATSAPP_MESSAGE)}`;
...
export default function RegisterPage() {
  ...
  const validateForm = () => {
    ...
    // Simple check: allows + and 1-15 digits. More robust validation may be needed.
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // *** CHANGE 1: Set state to show activation screen instead of redirecting
      setIsRegistered(true); 

      // OPTIONAL: Immediately open the WhatsApp link in a new tab if preferred
  ...
  // Password strength indicator logic (kept as is)
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50 flex items-center justify-center px-4 py-8 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-lg">
        ...
        <div className="bg-white/80 backdrop-blur-2xl rounded-3xl shadow-[0_8px_32px_0_rgba(16,185,129,0.15)] border border-white/30 overflow-hidden">
          ...
          {/* Header Section (adapted for both states) */}
          <div className="relative px-8 pt-10 pb-8 bg-gradient-to-br from-emerald-50/80 via-white/50 to-teal-50/60">
            <div className="text-center">
              {/* Logo/Icon */}
              <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl mb-5 shadow-lg shadow-emerald-500/25 transform transition-transform duration-300">
                {isRegistered ? (
              ...
              <h1 className="text-3xl font-bold text-gray-900 tracking-tight mb-2">
                {isRegistered ? "Activation Required" : "Join Whisone"}
              </h1>
              <p className="text-base text-gray-600">
                {isRegistered ? "One quick step to activate your AI Assistant" : "Start your AI second brain on WhatsApp"}
              </p>
            </div>
          </div>

          {/* *** CHANGE 2: Conditional Rendering of Content *** */}
          {isRegistered ? (
            // === STEP 1: WhatsApp Activation Screen ===
            <div className="px-8 pb-8 pt-6 relative text-center">
              <div className="space-y-6">
                <p className="text-xl font-semibold text-gray-800">
                  🎉 Your Whisone account is ready!
                </p>
                <p className="text-gray-600 leading-relaxed max-w-sm mx-auto">
                  To activate your assistant on WhatsApp, tap the button below. This sends the first message required by WhatsApp's compliance rules.
                </p>
                ...
                <p className="text-xs text-gray-500 pt-4">
                  (You will be automatically redirected to your dashboard once you click the button.)
                </p>
              </div>

              {/* Optional Link to Dashboard (if WhatsApp is not used) */}
            ...
            <div className="px-8 pb-8 pt-6 relative">
              ...
              <form onSubmit={handleSubmit} className="space-y-5 relative"> 
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="w-full pl-11 pr-12 py-3.5 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/40 focus:border-emerald-500 transition-all text-gray-900 placeholder-gray-400 disabled:opacity-50 disabled:cursor-not-allowed hover:border-300"
                    />
                    <button
                      type="button"
                  ...
                  {/* Password Strength Indicator (kept as is) */}
                  {formData.password && (
                ...
                {/* Submit Button (wrapped in form for standard submission) */}
                <button
