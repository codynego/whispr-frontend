        ...
        <header className="mb-10">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
            <div className="flex items-start gap-4">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-emerald-100 to-teal-100 rounded-3xl flex items-center justify-center shadow-lg flex-shrink-0">
                <Brain className="w-9 h-9 sm:w-11 sm:h-11 text-emerald-600" />
              </div>
            ...
            {/* Tabs — Now at the top for both mobile & desktop */}
            <nav className="w-full sm:w-auto">
              <div className="flex sm:hidden gap-1 bg-white/80 backdrop-blur p-1 rounded-2xl shadow-md border border-gray-100">
                {[
              ...
              <div className="hidden sm:flex gap-1 bg-white/80 backdrop-blur p-1 rounded-2xl shadow-md border border-gray-100">
                {[
                  { id: "training", icon: Brain, label: "Training" },
                  { id: "settings", icon: Settings, label: "Settings" },
                  { id: "analytics", icon: BarChart3, label: "Analytics" },
                ...
                <div className="bg-gradient-to-br from-red-50 to-pink-50 rounded-3xl border-2 border-red-200 p-6 sm:p-8 shadow-xl">
                  <div className="flex items-start gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-red-700">Irreversible action</p>
                    </div>
                  </div>
