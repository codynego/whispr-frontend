          ...
          <div className="px-8 pb-8 pt-6 relative">
            ...
            {isRegistered ? (
              <div className="space-y-6 text-center">
                <h2 className="text-2xl font-semibold text-gray-900">Activate Your WhatsApp Assistant</h2>
                ...
                <p className="text-sm text-gray-600">
                  This will open WhatsApp with a pre-filled message. Simply send it to activate your assistant instantly.
                </p>
                <button
                  onClick={handleSkip}
            ...
            {/* Login Link (only show if not registered) */}
            {!isRegistered && (
