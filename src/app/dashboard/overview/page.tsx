...
export default function WhisoneDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50">
      {/* Prevent horizontal scroll while keeping content visible */}
      <div className="w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="py-4">
              <div className="flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3 flex-1 justify-end min-w-0">
                  {/* Desktop Search */}
                  <div className="hidden md:flex items-center bg-gray-100 rounded-2xl px-4 py-2.5 w-full max-w-md">
          ...
          <main className="py-8 space-y-12">
            ...
            {/* Hero Section */}
            <section className="relative bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-600 rounded-3xl p-8 md:p-12 shadow-2xl overflow-hidden">
