    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50">
      ...
      <div className="overflow-x-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3 flex-1 justify-end">
                {/* Desktop Search */}
                <div className="hidden md:flex items-center bg-gray-100 rounded-2xl px-4 py-2.5 max-w-md w-full lg:w-96">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
              {[
                ...
                >
                  ...
                  <p className="font-semibold text-gray-900 text-sm text-center">{action.label}</p>
                  {action.highlight && (
          ...
          {/* Main Grid - Responsive & Contained */}
